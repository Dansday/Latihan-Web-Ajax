...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2983775219ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbajax&table=tblkaryawan">`dbajax`.`tblkaryawan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbajax&table=negara">`dbajax`.`negara`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbkaryawan&table=tblkaryawan">`dbkaryawan`.`tblkaryawan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpendaftaran&table=users">`dbpendaftaran`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4c463731643e6a497b55617c5b6e6959">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="dbajax" targettable="negara">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `negara`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbajax" targettable="negara">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `negara`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="dbajax" targettable="tblkaryawan">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tblkaryawan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbajax" targettable="negara">
                            <div class="action_content">
